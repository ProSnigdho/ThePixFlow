...
export default function ProfilePage() {
  ...
  // 2. Handle Image Upload (Fixed Stuck Loading)
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    const file = e.target.files?.[0];
    if (!file || !user) return;

    // Safety: Max size check (optional but good)
    ...
    try {
      ...
      // Update Firebase Auth Profile (Critical for consistency)
              ...
              <div className="space-y-12 relative z-10">
                 ...
                 <div className="flex flex-col items-center gap-6">
                    ...
                    <div className="text-center">
                       <h2 className="text-2xl font-black text-white tracking-tight uppercase">{formData.displayName || "PixFlow Member"}</h2>
                       <div className="flex flex-col items-center gap-1 mt-1">
                          <div className="flex items-center gap-2">
                             <CheckCircle2 size={12} className="text-[#1A8080]" />
                             <p className="text-[9px] font-black text-zinc-500 uppercase tracking-widest">Verified {userRole || "Identity"} Node</p>
                          </div>
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8">
                    ...
                    <div className="space-y-6">
                       ...
                       <div className="space-y-2">
                          <label className="text-[10px] font-black text-zinc-500 uppercase tracking-widest flex items-center gap-2">
                             <Phone size={12} className="text-[#1A4848]" /> Phone Number
                          </label>
                          <input 
                    ...
                    <div className="space-y-6">
                       ...
                       <div className="space-y-2">
                          <label className="text-[10px] font-black text-zinc-500 uppercase tracking-widest flex items-center gap-2">
                             <YoutubeIcon size={12} className="text-[#1A4848]" /> YouTube
                          </label>
                          <input 
                 ...
                 <div className="pt-8 flex flex-col items-center gap-4">
                    ...
                    >
                       ...
                       {saving ? "Transmitting..." : "Update Vault Identity"}
                    </button>
