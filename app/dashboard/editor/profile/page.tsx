...
export default function EditorProfilePage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast.success("Editor Identity Updated");
    } catch (error: any) {
              ...
              <div className="space-y-12 relative z-10">
                 ...
                 <div className="flex flex-col items-center gap-6">
                    ...
                    <div className="text-center">
                       <h2 className="text-2xl font-black text-white tracking-tight uppercase">{formData.displayName || "PixFlow Editor"}</h2>
                       <div className="flex flex-col items-center gap-1 mt-1">
                          <div className="flex items-center gap-2">
                             <CheckCircle2 size={12} className="text-[#1A8080]" />
                             <p className="text-[9px] font-black text-zinc-500 uppercase tracking-widest">Verified Production Node</p>
                          </div>
                 ...
                 <div className="pt-8 flex flex-col items-center gap-4">
                    ...
                    >
                       ...
                       {saving ? "Transmitting..." : "Update Editor Identity"}
                    </button>
